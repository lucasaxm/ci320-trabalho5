...
class BagsControllerTest < ActionController::TestCase
  ...
  test "should create bag" do
    assert_difference('Bag.count') do
      post :create, bag: { pokeballs: @bag.pokeballs, potions: @bag.potions, trainer_id: @bag.trainer_id }
    end
  ...
  test "should update bag" do
    patch :update, id: @bag, bag: { pokeballs: @bag.pokeballs, potions: @bag.potions, trainer_id: @bag.trainer_id }
    assert_redirected_to bag_path(assigns(:bag))
  end
